...
Call log:
  ...
  - waiting for locator('text=Dostawa').first()
    9 × locator resolved to <a href="/dostawa" class="relative px-4 py-2 rounded-xl font-body font-semibold text-sm transition-all duration-200 flex items-center gap-1.5 group↵                  text-beer-foam/50 hover:text-beer-foam/80">Dostawa 🚚</a>
...
- text: "✦ ✦ ✦ ✦ ✦ ✦ 🍺 Do piątku 17:00: 6d 04:41:27 🍺"
- img
